		...
		<div class="container" id="top_container">
			...
			<ul class="layui-nav right" lay-filter="">
				<li class="layui-nav-item">
					<a href="javascript:;">${ADMIN_SESSION_TAG.nickname}</a>
					<dl class="layui-nav-child">
						<!-- 二级菜单 -->
						<dd>
							<a onclick="WeAdminShow('个人信息','${pageContext.request.contextPath}/user/info?userId=${ADMIN_SESSION_TAG.id}')">个人信息</a>
						</dd>
						<dd>
							<a class="loginout" href="${pageContext.request.contextPath}/admin/exit">退出</a>
						</dd>
					</dl>
				</li>
		...
		<div class="page-content">
			<div class="layui-tab tab" lay-filter="wenav_tab" id="WeTabTip" lay-allowclose="true">
				<ul class="layui-tab-title" id="tabName">
					<li class=" first-tab">控制台</li>
				</ul>
				<div class="layui-tab-content">
					<div class="layui-tab-item layui-show">
						<iframe src='${pageContext.request.contextPath}/admin/welcome' frameborder="0" scrolling="yes" class="weIframe" style="height: 100%"></iframe>
					</div>
				</div>
			</div>
		</div>
...
//			});
			...
			layui.use(['jquery', 'admin', 'menu'], function(){
				var $ = layui.jquery,
					...
					menu = layui.menu;
				$(function(){
					menu.getMenu('${pageContext.request.contextPath}/admin/menu');
				});
			});
