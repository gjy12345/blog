...
<%--        <button class="layui-btn " onclick="addBlog()"><i class="layui-icon">&#xe654;</i>写博客</button>--%>
    ...
    <div class=" layui-inline">
        <label class="layui-form-label" style="width: auto">评论人:</label>
        <div class="layui-input-block">
            <select id="look_type">
                <option value="">所有人</option>
                <option value="0">只看我</option>
                <option value="1">不看我</option>
            </select>
        </div>
    </div>
    <div class="layui-inline">
...
<script type="text/javascript">
    ...
    function initData(page) {
        ...
        let url = '${pageContext.request.contextPath}/user/manage/comment/list?page=' + page
        +'&keyword='+name;
        if(showType!==''){
