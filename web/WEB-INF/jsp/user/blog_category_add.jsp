		...
		<div class="weadmin-body">
			...
			<form id="form1" class="layui-form">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="description" lay-verify="required" jq-error="请输入描述" placeholder="请输入描述" autocomplete="off" class="layui-input ">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">状态</label>
					<div class="layui-input-inline">
						<input type="radio" name="lock" title="启用" value="0" checked />
						<input type="radio" name="lock" title="禁用" value="1" />
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-input-block">
		...
		<script type="text/javascript">
			...
			layui.use(['admin','jquery','form', 'layer'], function() {
				...
				form.on('submit(add)', function(data) {
					...
					$.ajax({
						url: "${pageContext.request.contextPath}/user/manage/article/type/add",
						type: 'post',
						async: true,
