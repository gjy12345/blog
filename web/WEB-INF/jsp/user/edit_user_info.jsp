  ...
  <body>
                ...
                <div class="layui-input-inline">
                    <div class="col-sm-8">
                        <div class="form-control" style="height: 120px;">
                            <c:if test="${USER_SESSION_TAG.face==null}">
                                <img id="show_image"  style="height: 100px;width: 100px" src="${pageContext.request.contextPath}/static/img/face.png" alt="">
                            </c:if>
                            <c:if test="${USER_SESSION_TAG.face!=null}">
                                <img id="show_image"  style="height: 100px;width: 100px" src="${USER_SESSION_TAG.face}" alt="">
                            </c:if>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="username" name="username"
                         disabled="disabled"
                  autocomplete="off" value="${USER_SESSION_TAG.username}" class="layui-input">
              </div>
          </div>
            <div class="layui-form-item">
                <label for="username" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="nickname" name="nickname"
                           autocomplete="off" value="${USER_SESSION_TAG.nickname}" class="layui-input">
                </div>
            </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input layui-textarea">${USER_SESSION_TAG.sign}</textarea>
              </div>
          </div>
          <div class="layui-form-item">
    ...
    <script type="text/javascript">
        ...
        function submitData(){
            ...
            data['sign']=sign;
            $.ajax({
                url: "${pageContext.request.contextPath}/user/editSelf",
                type: "post",
