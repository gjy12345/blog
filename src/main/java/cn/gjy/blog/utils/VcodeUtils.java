...
public class VcodeUtils {
    private static final int w = 200;    //设置图片宽度
    private static final int h = 80;        //设置图片高度
    ...
    public static void writeImage(BufferedImage img, OutputStream out) throws Exception {
